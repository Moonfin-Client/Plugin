var MediaBar = {
  ...
  _loadContentAsync(settings) {
    ...
    this.waitForApi()
      ...
      .catch(function (e) {
        console.error(
          "[Moonfin] MediaBar: Failed to load content -",
          e.message,
        );
        document.body.classList.remove("moonfin-mediabar-active");
  ...
  createMediaBar() {
    ...
    var settings = Storage.getAll();
    var overlayColor = Storage.getColorRgba(
  ...
  updateDisplay() {
    ...
    var logoContainer = this.container.querySelector(
      ".moonfin-mediabar-logo-container",
    );
    ...
    var ratingBadge = this.container.querySelector(
      ".moonfin-mediabar-rating-badge",
    );
  ...
  startTrailerPreview(videoId) {
    ...
    this._ensureYTApi(function () {
      if (
        self._trailerState !== "resolving" ||
        self._trailerVideoId !== videoId
      )
        return;
      self
  ...
  _loadYTPlayer(videoId) {
    ...
    var trailerContainer = this.container.querySelector(
      ".moonfin-mediabar-trailer-container",
    );
      ...
      this._trailerPlayer = new YT.Player(playerDiv.id, {
        ...
        events: {
          ...
          onError: function (event) {
            console.warn(
              "[Moonfin] MediaBar: YouTube player error:",
              event.data,
            );
  ...
  updateBackdrop(url) {
    var current = this.container.querySelector(
      ".moonfin-mediabar-backdrop-current",
    );
  ...
  setupEventListeners() {
    ...
    this.container
      .querySelector(".moonfin-mediabar-prev")
    ...
    this.container
      .querySelector(".moonfin-mediabar-next")
      .addEventListener("click", function (e) {
        e.stopPropagation();
        self.nextSlide();
      });
    ...
    this.container
      .querySelector(".moonfin-mediabar-dots")
      .addEventListener("click", function (e) {
        e.stopPropagation();
    ...
    this.container.addEventListener("click", function (e) {
      if (
        e.target.closest(
          ".moonfin-mediabar-nav-btn, .moonfin-mediabar-dots, .moonfin-mediabar-dots-wrap",
        )
      ) {
        return;
      }
  ...
  applySettings(settings) {
    ...
    this.container
      .querySelectorAll(".moonfin-mediabar-nav-btn")
